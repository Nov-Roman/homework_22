...
class Boat(Transport):
    def start_engine(self):
        return print('Двигатель катера запущен')

    def stop_engine(self):
        return print('Двигатель катера остановлен')

    def move(self):
        return print('Катер движется')
...
class Car(Transport):
    def start_engine(self):
        return print('Двигатель автомобиля запущен')

    def stop_engine(self):
        return print('Двигатель автомобиля остановлен')
...
class Electroscooter(Transport):
    def start_engine(self):
        return print('Двигатель скутера запущен')

    def stop_engine(self):
        return print('Двигатель скутера остановлен')

    def move(self):
        return print('Скутер движется')
